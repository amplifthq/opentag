...
program
  ...
  .option("--line-account-id <id>", "LINE account id/destination or local account key")
  .option("--line-channel-secret <secret>", "LINE channel secret")
  .option("--line-channel-access-token <token>", "LINE channel access token")
  .option("--line-conversation-id <id>", "LINE userId, groupId, roomId, or auto to bind")
  .option("--line-port <port>", "Local LINE webhook port")
