...
program
  ...
  .option("--github-token <token>", "GitHub token for comments and optional pull requests")
  ...
  .option("--github-auto-create-pr", "Allow OpenTag to create pull requests when runs change files")
  .option("--no-github-auto-create-pr", "Do not allow OpenTag to create pull requests")
