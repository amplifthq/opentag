...
program
  ...
  .option("--discord-public-key <key>", "Discord application public key (64 hex characters)")
  .option("--discord-bot-token <token>", "Discord bot token for callbacks and notices")
  .option("--discord-channel-id <id>", "Discord channel id to bind")
  .option("--discord-webhook-path <path>", "Discord interactions path on the dispatcher")
