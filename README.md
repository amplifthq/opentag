...
3. Run opentag setup and help me choose Slack, GitHub, GitLab, Lark / Feishu, Telegram, Discord, or Microsoft Teams, a coding agent, and a local project.
...
```mermaid
flowchart LR
    A["Slack, GitHub, GitLab, Lark / Feishu, Telegram, Discord, or Microsoft Teams"] --> B["OpenTag listener"]
